				...
				<div class="collapse navbar-collapse" id="main-menu">
					<ul class="menu">
						...
						<li class="nav-current" role="presentation"><a
							href="userInfoServlet.do">用户</a></li>
			...
			<div class="widget">
				...
				<div class="content community">
					<c:if test="${sessionScope.account!=null}">
						<h4>用户名:${sessionScope.account.account}</h4>
						<form class="form-horizontal"
							action="userInfoServlet.do?md=update" method="post">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">邮箱：</label>
								<div class="col-sm-10">
									<input type="email" class="form-control" name="userinfoemail"
										id="userinfoemail" value="${sessionScope.account.email}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<c:if test="${requestScope.jspuserinfo.sex=='m'}">
										<input type="radio" name="userinfosex" id="userinfosex"
											value="m" checked="true">&nbsp&nbsp男&nbsp&nbsp&nbsp&nbsp
			             	 <input type="radio" name="userinfosex"
											id="userinfosex" value="f">&nbsp&nbsp女
						</c:if>
									<c:if test="${requestScope.jspuserinfo.sex!='m'}">
										<input type="radio" name="userinfosex" id="userinfosex"
											value="m">&nbsp&nbsp男&nbsp&nbsp&nbsp&nbsp
			             	 <input type="radio" name="userinfosex"
											id="userinfosex" value="f" checked="true">&nbsp&nbsp女
						</c:if>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="userinfoage"
										id="userinfoage" value="${requestScope.jspuserinfo.age}">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="userinfoqq"
										id="userinfoqq" value="${requestScope.jspuserinfo.qq}">
								</div>
							</div>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">手机号：</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="userinfophone"
										id="userinfophone" value="${requestScope.jspuserinfo.phone}">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										name="userinfodescription" id="userinfodescription"
										value="${requestScope.jspuserinfo.description}">
								</div>
							</div>
							<!-- 省市二级联动 -->
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select class="form-control" id="prov" name="prov">
										...
										<c:forEach items="${jsprovince}" var="province"
											varStatus="index">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="userinfolocation"
										id="userinfolocation"
										value="${requestScope.jspuserinfo.location}">
								</div>
							</div>
					...
					<c:if test="${sessionScope.account==null}">
						<br>
						<h3 style="color: red">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp对不起，您尚未登录，请登录后进行操作！</h3>
					</c:if>
				</div>
			</div>
			...
			<div class="widget">
				...
				<c:if test="${sessionScope.account!=null}">
					...
					<div class="content community">
						...
						<a href="posttext.jsp" class="btn btn-default">发布主题 </a> <a
							href="logoutServlet.do" class="btn btn-default"
