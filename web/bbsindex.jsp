...
<title>论坛首页 学习论坛</title>
<meta name="description"
	content="学习论坛 Open source blogging platform 。" />
<meta name="keywords" content="学习论坛,学习，论坛">
...
<link rel="alternate" type="application/rss+xml" title="学习论坛" href="#" />
...
<body class="home-template">
	...
	<div class="container">
		<div class="row">
			...
			<div class="widget">
				<h4 class="title">全部主题</h4>
				<div class="content community">
					<c:if test="${sessionScope.account!=null}">
						<a href="posttext.jsp" class="btn btn-default">点击发帖 </a><br>
						<table class="table table-hover">
							...
							<c:forEach items="${jspAllText}" var="invitation"
								varStatus="index">
								<tr>
									<td>${index.count}</td>
									<td><a href="textServlet.do?md=read&pid=${invitation.id}">${invitation.title}</a></td>
									<td>${invitation.account}</td>
									<td>${invitation.time}</td>
								</tr>
							</c:forEach>
						</table>
						<a href="posttext.jsp" class="btn btn-default">点击发帖 </a>
					</c:if>
					<c:if test="${sessionScope.account==null}">
						<br>
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<span>Copyright &copy; <a href="#">学习论坛</a></span> | <span><a
