		...
		<div class="row">
			...
			<div class="widget">
				...
				<div class="content community">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="texttitle"
										id="texttitle" value="${jspinvitation.title}">
								</div>
							</div>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">正文：</label>
								<div class="col-sm-10">
									<textarea class="form-control" rows="20" name="textarticle"
										id="textarticle">${jspinvitation.article}</textarea>
								</div>
							</div>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">时间：</label>
								<div class="col-sm-10">
									<h5>${jspinvitation.time}</h5>
								</div>
							</div>
					...
					<c:if test="${sessionScope.account==null}">
						<br>
						<h3 style="color: red">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp对不起，您尚未登录，请登录后操作！</h3>
					</c:if>
				</div>
			</div>
