			...
			<div class="col-sm-12">
				...
				<div class="collapse navbar-collapse" id="main-menu">
					<ul class="menu">
						...
						<li class="nav-current" role="presentation"><a href="textServlet.do">我的帖子</a></li>
				...
				<div class="content community">
					<c:if test="${sessionScope.account!=null}">
						<table class="table table-hover">
							...
							<c:forEach items="${jsptextlist}" var="invitation"
								varStatus="index">
								<tr>
									<td>${index.count}</td>
									<td><a href="textServlet.do?md=read&pid=${invitation.id}">${invitation.title}</a></td>
									<td>${invitation.time}</td>
									<td><a href="textServlet.do?md=edit&pid=${invitation.id}"
										class="btn btn-default">编辑 </a> <a
										href="textServlet.do?md=delete&pid=${invitation.id}"
										class="btn btn-default">删除 </a></td>
								</tr>
							</c:forEach>
						</table>
						<a href="posttext.jsp" class="btn btn-default">点击发帖
						</a>
					</c:if>
					<c:if test="${sessionScope.account==null}">
						<br>
