...
<title>${jspinvitation.title}-学习 论坛</title>
	...
	<div class="container">
		<div class="row">
			...
			<c:if test="${sessionScope.account!=null}">
				<main class="col-md-8 main-content"> <article id=98
					class="post">

				<div class="post-head">
					<h1 class="post-title">
						<a href="/moving-to-node-js-v4-lts/">${jspinvitation.title}</a>
					</h1>
					<div class="post-meta">
						<span class="author">作者：${jspinvitation.account}</span>
						&bull;
						<time class="post-date" >${jspinvitation.time}</time>
					</div>
				</div>
				...
				<div class="pull-left tag-list">
					<i class="fa fa-folder-open-o"></i><h4> <b>最新评论</b></h4><br>
					<c:forEach items="${jspreview}" var="review" varStatus="index">
						<span><b>${review.observer}:</b>&nbsp&nbsp${review.comment} &nbsp&nbsp&nbsp&nbsp ${review.ctime}</span><br>
					</c:forEach>
				...
				<div class="content community">
						<form class="form-horizontal" action="textServlet.do"
							method="post">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">内容：</label>
								<div class="col-sm-10">
									<textarea class="form-control" rows="3" name="textcomment"
										id="textcomment"></textarea>
								</div>
							</div>
							<input type="hidden" name="pid" value=${jspinvitation.id}>
							<input type="hidden" name="md" value="postcomment">
							<input type="hidden" name="postobserver" value="${sessionScope.account.account}">
							<div class="form-group">
			...
			<div class="widget">
				...
				<c:if test="${sessionScope.account!=null}">
					...
					<div class="content community">
						...
						<a href="userInfoServlet.do" class="btn btn-default">个人资料 </a> <a
							href="logoutServlet.do" class="btn btn-default"
							onclick="return logOut()">退出登录 </a> <a href="posttext.jsp"
							class="btn btn-default">发布主题 </a>
					</div>
				</c:if>
