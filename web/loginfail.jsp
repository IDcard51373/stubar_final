...
<title>登录失败-BUG 论坛</title>
<meta name="description"
	content="BUG 论坛 Open source blogging platform 。" />
<meta name="keywords" content="学习 论坛,BUG,BUG中文">
...
<link rel="alternate" type="application/rss+xml" title="BUG 论坛" href="#" />
...
<body class="home-template">
		...
		<div class="row">
			...
			<div class="widget">
				...
				<div class="content community">
					<h4 style="color: red;">提示:账号或密码错误</h4>
					<form class="form-horizontal" action="userServlet.do" method="post">
	...
	<div class="copyright">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<span>Copyright &copy; <a href="#">BUG 论坛</a></span> | <span><a
